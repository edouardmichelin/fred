...
fun EnergyOnboardingScreen(
    ...
    Column(
        ...
        Text(
            text = "We need to fetch your energy consumption details. Please allow location access or select a country.",
