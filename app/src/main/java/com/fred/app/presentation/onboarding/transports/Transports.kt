  ...
  Column(
      ...
      horizontalAlignment = Alignment.Start) {
        ...
        if (ownsCar) {
          ...
          Divider(thickness = 1.dp, color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.3f))
          Spacer(modifier = Modifier.height(16.dp))
        ...
        ChipGroup(
            options = listOf("< 500 km", "500–3000 km", ">3000 km"),
              ...
              onClick = {
                if (ownsCar) {
                  viewModel.createVehicle(
                      ...
                      name = "My Car",
                      fuelType =
                          FuelType.values().firstOrNull { it.name == carType } ?: FuelType.Diesel,
